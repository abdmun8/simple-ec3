            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="<?php echo base_url('add/category') ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> Tambah Kategori</span></a></li>
                        <li><a href="<?php echo base_url('manage/category') ?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Kelola Kategori</span></a></li>
                        <li><a href="<?php echo base_url('add/brand') ?>"><i class="icon-edit"></i><span class="hidden-tablet"> Tambah Merek</span></a></li>
                        <li><a href="<?php echo base_url('manage/brand') ?>"><i class="icon-list-alt"></i><span class="hidden-tablet"> Kelola Merek</span></a></li>
                        <li><a href="<?php echo base_url('add/product') ?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Tambah Produk</span></a></li>
                        <li><a href="<?php echo base_url('manage/product') ?>"><i class="icon-dashboard"></i><span class="hidden-tablet"> Kelola Produk</span></a></li>

                        <li><a href="<?php echo base_url('add/slider') ?>"><i class="icon-font"></i><span class="hidden-tablet"> Tambah Slider</span></a></li>
                        <li><a href="<?php echo base_url('manage/slider') ?>"><i class="icon-picture"></i><span class="hidden-tablet"> Kelola Slider</span></a></li>
                        <li><a href="<?php echo base_url('theme/option'); ?>"><i class="icon-align-justify"></i><span class="hidden-tablet"> Pengaturan Tema</span></a></li>
                        <li><a href="<?php echo base_url('order/manage_order'); ?>"><i class="icon-calendar"></i><span class="hidden-tablet"> Kelola Pemesanan</span></a></li>
                    </ul>
                </div>
            </div>
            <!-- end: Main Menu -->
