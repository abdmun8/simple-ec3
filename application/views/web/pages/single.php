        ...
        <div class="section group">
            <div class="cont-desc span_1_of_2">
                ...
                <div class="desc span_3_of_2">
                    ...
                    <div class="price">
                        <p>Harga: Rp. <span><?php echo $this->cart->format_number($get_single_product->product_price) ?></span></p>
                        <p>Kategori: <span><?php echo $get_single_product->category_name ?></span></p>
                        <p>Merek:<span><?php echo $get_single_product->brand_name ?></span></p>
                    </div>
                    <div class="add-cart">
