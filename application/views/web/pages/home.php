        ...
        <div class="section group">
            ...
            ?>
                <div class="grid_1_of_4 images_1_of_4">
                    ...
                    <p><span class="price"><?php echo "Rp. " .  $this->cart->format_number($single_feature_product->product_price); ?></span></p>
        ...
        <div class="section group">
            <?php foreach ($all_new_products as $single_new_product) { ?>
                <div class="grid_1_of_4 images_1_of_4">
                    ...
                    <p><span class="price"><?php echo "Rp. " . $this->cart->format_number($single_new_product->product_price); ?></span></p>
